...
> 📌 **近期工作（2026-08-17，版本 0.385；详见 SKILL.md / CHANGELOG.md）**：
> - 新增玩家友方单位·仓鼠民兵：近战、攻击动画第 8 帧判定 20 物理伤害、HP 125、
>   移速 150、六维走怪物公式；兵营/草屋双链路生成，CDP 探针已备（用户实机自测）。
> - 修复产兵建筑 applyUpgradesToUnits 从 ai 块误读 baseMaxHp（恒 300）的问题。
>
> 历史（2026-08-16，版本 0.384）：
> - 世界-122 荒漠化：树木全删（资产/散布/生成管线），改撒仙人掌 4 姿态障碍物
>   （obstacle_cactus_*）+ 荒漠植物点缀（deco_desert_1~4），`cactusScatter` 配置；
> - 新增玩家友方单位·仓鼠盾卫（兵营第三种单位）：12 帧攻击单次播放、第 10 帧
>   判定 30 物理伤害、HP 300、移速 100；仓鼠单位生命 战士225/盾卫300/矿工100/射手150；
> - 仓鼠单位六维派生一律走怪物公式（statFormula:'enemy'：atk/def/matk/mdef/crit/critRes），
>   伊莉丝/露娜按玩家公式（测试锁定）；
> - 仓鼠单位音效（assets/sounds/friendly/：射手出膛/战士盾卫共用/矿工挥锄，playWorld
>   坐标衰减）；友军 HUD 一律只显血条不显名字。
> - 测试：npm test 全绿；test-hamster-guard 59 项、test-hamster-warrior 35 项。
