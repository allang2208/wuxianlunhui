...
export const HAMSTER_UNIT_CATEGORIES = Object.freeze({
    ...
    anti_tank_rifleman: HAMSTER_UNIT_CATEGORY.INFANTRY,
    ...
    service_rifleman: HAMSTER_UNIT_CATEGORY.INFANTRY,
    emplaced_machine_gun_crew: HAMSTER_UNIT_CATEGORY.INFANTRY,
    ...
    industrial_carbine_cavalry: HAMSTER_UNIT_CATEGORY.CAVALRY,
    gunpowder_explosive_lancer: HAMSTER_UNIT_CATEGORY.CAVALRY,
    camel_cavalry: HAMSTER_UNIT_CATEGORY.CAVALRY,
    priest: HAMSTER_UNIT_CATEGORY.MAGIC,
    bishop: HAMSTER_UNIT_CATEGORY.MAGIC,
    archbishop: HAMSTER_UNIT_CATEGORY.MAGIC,
