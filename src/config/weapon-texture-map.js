...
export function getWeaponTextureKey(item) {
    ...
    const specialMap = {
        ...
        weapon49: 'weapon_m1911a1',
        weapon50: 'weapon_usp45',
        weapon51: 'weapon_five_seven',
        weapon52: 'weapon_eternal_edict',
        weapon53: 'weapon_falcon_edict',
        weapon54: 'weapon_crimson_crown_settlement',
        weapon55: 'weapon_myriad_corridor',
        weapon56: 'weapon_forged_duelist_buckler',
        weapon57: 'weapon_oak_garrison_shield',
        weapon58: 'weapon_moonsilver_deflection_shield',
        weapon59: 'weapon_blackiron_citadel_shield',
        weapon60: 'weapon_thorn_oath_reprisal_shield',
        weapon61: 'weapon_star_eater_arcane_mirror_shield',
        weapon62: 'weapon_heaven_pillar_returning_bulwark',
        weapon63: 'weapon_abyss_return_star_devouring_mirror',
        weapon64: 'weapon_reverse_fate_doomwheel_shield',
        weapon65: 'weapon_last_oath_sanctum_gate_shield',
...
export function getWeaponTextureLoadList() {
    return [
        ...
        { key: 'weapon_m1911a1', path: 'assets/weapons/m1911a1-equip.png' },
        { key: 'weapon_usp45', path: 'assets/weapons/usp45-equip.png' },
        { key: 'weapon_five_seven', path: 'assets/weapons/five-seven-equip.png' },
        { key: 'weapon_eternal_edict', path: 'assets/weapons/eternal-edict-equip.png' },
        { key: 'weapon_falcon_edict', path: 'assets/weapons/falcon-edict-equip.png' },
        { key: 'weapon_crimson_crown_settlement', path: 'assets/weapons/crimson-crown-settlement-equip.png' },
        { key: 'weapon_myriad_corridor', path: 'assets/weapons/myriad-corridor-equip.png' },
        ...
        { key: 'weapon_forged_duelist_buckler', path: 'assets/weapons/forged-duelist-buckler-equip.png' },
        { key: 'weapon_oak_garrison_shield', path: 'assets/weapons/oak-garrison-shield-equip.png' },
        { key: 'weapon_moonsilver_deflection_shield', path: 'assets/weapons/guards/moonsilver-deflection-shield-guard.png' },
        { key: 'weapon_blackiron_citadel_shield', path: 'assets/weapons/guards/blackiron-citadel-shield-guard.png' },
        { key: 'weapon_thorn_oath_reprisal_shield', path: 'assets/weapons/guards/thorn-oath-reprisal-shield-guard.png' },
        { key: 'weapon_star_eater_arcane_mirror_shield', path: 'assets/weapons/guards/star-eater-arcane-mirror-shield-guard.png' },
        { key: 'weapon_heaven_pillar_returning_bulwark', path: 'assets/weapons/guards/heaven-pillar-returning-bulwark-guard.png' },
        { key: 'weapon_abyss_return_star_devouring_mirror', path: 'assets/weapons/guards/abyss-return-star-devouring-mirror-guard.png' },
        { key: 'weapon_reverse_fate_doomwheel_shield', path: 'assets/weapons/guards/reverse-fate-doomwheel-shield-guard.png' },
        { key: 'weapon_last_oath_sanctum_gate_shield', path: 'assets/weapons/guards/last-oath-sanctum-gate-shield-guard.png' },
