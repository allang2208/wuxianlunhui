...
import structureShadowCasters from '../../data/structure-shadow-casters.json';
import { registerStructureGroundFitManifest } from '../world/structure-visual-anchor.js';
import { registerStructureShadowCasterManifest } from '../world/structure-shadow-caster.js';
...
export const STRUCTURE_SHADOW_CASTER_ENTRY_COUNT =
    registerStructureShadowCasterManifest(structureShadowCasters);
