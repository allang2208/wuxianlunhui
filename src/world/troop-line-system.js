...
const MILITARY_KINDS = new Set([
    'militia', 'halberd', 'anti_vehicle', 'warrior', 'champion', 'shooter', 'guard', 'phalanx', 'riot_special', 'scout', 'ranger', 'heavy_machine_gunner', 'sniper', 'musketeer', 'priest', 'knight', 'light_cavalry', 'ninja',
    'camel_cavalry',
    'explorer',
    'bounty_hunter',
    'jaguar_warrior',
