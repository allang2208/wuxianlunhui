 ...
 * ============================================================
 *
 * 15 个恐怖事件、15 个沼泽事件、15 个雪原事件与 15 个废弃矿洞事件：
 * - 恐怖事件按C/B/A各5个重排，收益、检定和战斗编组随事件级别升级
...
export const RESTRICTED_EVENT_META = {
    ...
    collapsedArchway: { grade: 'C', scope: 'zombie' },
    undeadScholarNotes: { grade: 'B', scope: 'zombie' },
    bloodAltar: { grade: 'B', scope: 'zombie' },
    mistyCrossroad: { grade: 'C', scope: 'zombie' },
    cursedArmor: { grade: 'B', scope: 'zombie' },
    poisonMushroomCircle: { grade: 'C', scope: 'zombie' },
    abyssalGambler: { grade: 'A', scope: 'zombie' },
    blessedFountain: { grade: 'B', scope: 'zombie' },
    lockedArmory: { grade: 'A', scope: 'zombie' },
    phantomMirror: { grade: 'A', scope: 'zombie' },
    quarantineBell: { grade: 'C', scope: 'zombie' },
    corpseWaxWorkshop: { grade: 'B', scope: 'zombie' },
    sealedSurvivorCell: { grade: 'C', scope: 'zombie' },
    ossuaryOrgan: { grade: 'A', scope: 'zombie' },
    plagueSpecimenVault: { grade: 'A', scope: 'zombie' },
...
export const NEW_EVENT_CONFIGS = {
        ...
        choices: [
            {
                ...
                success: {
                    ...
                    specialItems: [{ type: 'enhancement_stone', count: 2 }],
                },
                fail: {
        ...
        choices: [
            {
                id: 'decipherSpell',
                label: '智力解读',
                description: '尝试理解古代咒语；失败损失魔法并进入3阶段追击战',
                attribute: 'int',
                baseRate: 20,
                success: {
                ...
                fail: {
                    ...
                    mpRestorePercent: -20,
                    combat: 'normal', encounter: { combatWaves: 3, monstersPerWave: 5, waveComposition: [{ normal: 5 }, { normal: 5 }, { elite: 1, normal: 4 }] },
                },
            },
            {
                id: 'senseTrap',
                label: '精神感知',
                description: '用精神力探测诅咒；失败损失魔法并进入3阶段追击战',
                attribute: 'wis',
                baseRate: 30,
                success: {
        ...
        choices: [
            ...
            },
            {
                ...
                success: {
                    ...
                    specialItems: [{ type: 'magic_dust', count: 450 }],
                },
                fail: {
        ...
        choices: [
            {
                id: 'spiritGuidance',
                label: '精神指引',
                description: '聆听迷雾中的真实低语；误判会进入3阶段尸群追击',
                attribute: 'wis',
                baseRate: 35,
                success: {
                ...
                fail: {
                    ...
                    combat: 'normal', encounter: { combatWaves: 3, monstersPerWave: 5, waveComposition: [{ normal: 5 }, { normal: 5 }, { normal: 5 }] },
                },
            },
            {
                id: 'luckyWander',
    ...
    cursedArmor: {
        ...
        choices: [
            ...
            },
            {
                id: 'forceDismantle',
                label: '力量拆解',
                description: '砸开板甲搜刮材料；失败进入5阶段精英战，骑士在末段苏醒',
                attribute: 'str',
                baseRate: 20,
                success: {
                    text: '你用重击砸碎了板甲的胸甲，怨灵发出一声不甘的尖啸后消散。铆钉下藏着强化石，散出的魔力凝成了魔法粉尘。',
                    specialItems: [{ type: 'enhancement_stone', count: 3 }, { type: 'magic_dust', count: 400 }],
                },
                fail: {
                    text: '你的重击没有破坏盔甲，反而让怨灵彻底苏醒。板甲自己站了起来，空洞的头盔中亮起猩红的光芒。',
                    combat: 'elite',
                    forceMonsters: ['armoredKnight'],
                    encounter: { combatWaves: 5, monstersPerWave: 5, waveComposition: [{ elite: 1, normal: 4 }, { elite: 1, normal: 4 }, { elite: 1, normal: 4 }, { elite: 1, normal: 4 }, { normal: 5 }] },
                },
            },
            {
                id: 'sealArmorStand',
        ...
        choices: [
            {
                ...
                baseRate: 30,
                success: {
                    text: '你仔细观察孢子囊的膨胀节奏，在孢子喷发间隙迅速采下几株菌盖。你用布包好它们，没有吸入任何毒粉，你将这些药菇炼成浓缩药剂，补充生命与魔法。',
                    hpPotion: 80,
                    mpPotion: 60,
                },
                fail: {
        ...
        choices: [
            {
                ...
                baseRate: 15,
                success: {
                    text: '三颗骰子同时停在相同的深渊之眼上，赌徒发出不甘的低吼。它被迫将赌注推向你，包括一袋金币和三张改造券。',
                    gold: { min: 400, max: 600 },
                    specialItems: [{ type: 'reforge_ticket', count: 3 }],
                },
                fail: {
                    damagePercent: 15,
                    text: '骰子停在骷髅图案上，赌徒同时抽走鲜血和金币作为赌资。',
                    gold: { min: -350, max: -250 },
                },
            },
            {
                id: 'countCards',
                ...
                success: {
                    ...
                    specialItems: [{ type: 'reforge_ticket', count: 2 }],
                },
                fail: {
                    text: '赌徒抢先改了骰面，罚金符文从钱袋里吸走金币。你中止争辩，才让阴影退回墙角。',
                    gold: { min: -300, max: -200 },
                },
            },
            {
                id: 'leave',
                ...
                outcome: {
                    ...
                    combat: 'elite', encounter: { combatWaves: 5, monstersPerWave: 5, waveComposition: [{ elite: 1, normal: 4 }, { elite: 1, normal: 4 }, { elite: 1, normal: 4 }, { elite: 1, normal: 4 }, { lord: 1, normal: 4 }] },
                },
            },
        ],
    },
        ...
        choices: [
            {
                ...
                fail: {
                    text: '泉水的寒毒在体内爆发，伤口被冰晶撕裂，魔力也随呕出的泉水流失。',
                    damagePercent: 20,
                    mpRestorePercent: -10,
                },
            },
            {
                ...
                baseRate: 25,
                success: {
                    text: '你的精神力像滤网一样分离了寒气，纯净的魔力注入你的体内。魔法池重新充盈，疲惫也得到了缓解。',
                    mpRestorePercent: 60,
                    healPercent: 35,
                },
                fail: {
                    text: '寒气顺着你的精神触须反噬，你感到一阵剧烈的头痛。你付出生命与魔力才切断联系，泉水随后恢复平静。',
                    damagePercent: 15,
                    mpRestorePercent: -20,
                },
            },
        ...
        choices: [
            {
                id: 'pickLock',
                label: '敏捷撬锁',
                description: '撬开锁芯；失败进入5阶段精英战，末段有领主与刽子手',
                attribute: 'dex',
                baseRate: 15,
                success: {
                    text: '锁芯发出清脆的咔哒声，铁门缓缓打开。门后的守卫早已化为白骨，只剩下散落的强化石和一袋魔法粉尘。',
                    specialItems: [{ type: 'enhancement_stone', count: 4 }, { type: 'magic_dust', count: 700 }],
                },
                fail: {
                    forceMonsters: ['stitchfaceHeadsman'],
            ...
            },
            {
                id: 'breakDoor',
                label: '力量破门',
                description: '用蛮力撞开铁门；失败进入5阶段精英战，末段有领主与骑士',
                attribute: 'str',
                baseRate: 20,
                success: {
                    text: '你用肩膀撞开铁门，腐朽的门轴发出刺耳的呻吟。门后的守卫幽魂尚未凝聚成形，你迅速搜刮了强化石和魔法粉尘。',
                    specialItems: [{ type: 'enhancement_stone', count: 4 }, { type: 'magic_dust', count: 600 }],
                },
                fail: {
                    forceMonsters: ['armoredKnight'],
        ...
        choices: [
            ...
            },
            {
                ...
                outcome: {
                    ...
                    combat: 'normal', encounter: { combatWaves: 3, monstersPerWave: 5, waveComposition: [{ normal: 5 }, { elite: 1, normal: 4 }, { elite: 1, normal: 4 }] },
                },
            },
        ],
    },
    quarantineBell: {
        ...
        choices: [
            {
                id: 'readBellCode', label: '精神辨钟', description: '从残留回声中辨认安全警报码', attribute: 'wis', baseRate: 35,
                success: { text: '你听出短促回声对应旧守卫的撤离暗号，附近安全路线与藏匣位置一并清晰起来。', revealNodes: true, revealDepth: 2, gold: { min: 60, max: 100 } },
                fail: { text: '重叠的钟声在意识里反复震荡，你误读了墙上的一个危险标记。', mpRestorePercent: -15, damagePercent: 15 },
            },
            {
                id: 'climbBellFrame', label: '敏捷登架', description: '沿断梁攀上钟架，取下钱匣和钟舌', attribute: 'dex', baseRate: 30,
                success: { text: '你避开松动横梁攀到钟顶，取下密封钱匣，匣内还藏着两枚强化石。', gold: { min: 100, max: 140 }, specialItems: [{ type: 'enhancement_stone', count: 2 }] },
                fail: { text: '腐朽踏板突然折断，你被钟绳卷住后重重撞在石墙上。', damagePercent: 20 },
            },
    ...
    corpseWaxWorkshop: {
        ...
        choices: [
            {
                id: 'refineCorpseWax', label: '智力精炼', description: '控制铜锅温度，分离药性与腐毒', attribute: 'int', baseRate: 25,
                success: { text: '你按锅壁刻度滤掉腐毒，凝成一瓶可用药剂和一袋高纯魔尘。', hpPotion: 150, specialItems: [{ type: 'magic_dust', count: 400 }] },
                fail: { text: '尸蜡突然沸腾，灼热脂液溅出铜锅，刺鼻烟气同时钻入肺部。', damagePercent: 25, mpRestorePercent: -15 },
            },
            {
                id: 'clearVent', label: '体质清炉', description: '忍住毒烟，徒手清理堵塞的抽风炉', attribute: 'con', baseRate: 25,
                success: { text: '你顶着腐味疏通炉道，冷却后的蜡膜附在护甲表面，形成一层短暂缓冲。', healPercent: 20, buff: { id: 'corpseWaxSeal', name: '尸蜡封层', icon: '🕯️', color: '#c8b997', defPercent: 15, durationBattles: 3 } },
                fail: { text: '炉道里的陈年毒烟正面喷出，尸蜡冷凝在关节上，让动作变得僵硬。', buff: { id: 'waxStiffness', name: '尸蜡僵结', icon: '🕯️', color: '#81745f', moveSpeedPercent: -20, durationBattles: 3 } },
            },
    ...
    sealedSurvivorCell: {
        ...
        choices: [
            {
                id: 'verifySurvivor', label: '精神辨伪', description: '用旧守卫问答确认身份；误判会进入3阶段尸群追击', attribute: 'wis', baseRate: 30,
                success: { text: '门后的幸存者完整答出换岗暗语，从送饭口递出备用药剂和标有安全岔路的地图。', hpPotion: 80, mpPotion: 60, revealNodes: true, revealDepth: 2 },
                fail: { text: '最后一句回答变成了饥饿嘶吼，门板随即被尸群从里面撞碎。', combat: 'normal', forceMonsters: ['zombie', 'zombieDog'], encounter: { combatWaves: 3, monstersPerWave: 5, waveComposition: [{ normal: 5 }, { normal: 5 }, { normal: 5 }] } },
            },
            {
                id: 'breakCell', label: '力量破封', description: '直接拆掉障碍；失败会进入3阶段尸群追击', attribute: 'str', baseRate: 25,
                success: { text: '你掀开柜架并扯断铁链，门后的活人早已离去，只留下藏在床板下的钱袋和强化石。', gold: { min: 100, max: 160 }, specialItems: [{ type: 'enhancement_stone', count: 2 }] },
                fail: { text: '障碍倒塌的巨响惊醒了牢内尸体，一只臃肿僵尸带着同类堵住出口。', combat: 'normal', forceMonsters: ['fatZombie', 'zombie'], encounter: { combatWaves: 3, monstersPerWave: 5, waveComposition: [{ normal: 5 }, { normal: 5 }, { normal: 5 }] } },
            },
    ...
    ossuaryOrgan: {
        ...
        choices: [
            {
                id: 'playFuneralMeasure', label: '敏捷奏曲', description: '演奏送葬小节；错音引发5阶段精英战，末段有领主与巫师', attribute: 'dex', baseRate: 15,
                success: { text: '最后一个和弦准确落下，壁龛尸骸重新安眠，银音栓中释放的节拍强化了你的攻势。', gold: { min: 240, max: 360 }, buff: { id: 'funeralTempo', name: '送葬节拍', icon: '🎼', color: '#9aa7b5', atkPercent: 20, matkPercent: 20, durationBattles: 3 } },
                fail: { text: '错音像尖叫般穿透墓室，沉睡的僵尸巫师从风琴后方现身，接管了未完的乐章。', combat: 'elite', forceMonsters: ['zombieWizard'], encounter: { combatWaves: 5, monstersPerWave: 5, waveComposition: [{ elite: 1, normal: 4 }, { elite: 1, normal: 4 }, { elite: 1, normal: 4 }, { elite: 1, normal: 4 }, { lord: 1, normal: 4 }] } },
            },
            {
                id: 'retuneBonePipes', label: '智力校音', description: '根据骨管长度还原机关的正确音阶', attribute: 'int', baseRate: 20,
                success: { text: '你校正了错位音管，风琴奏出的回声标出墓室暗门，并弹出三张藏在键盘下的改造券。', revealNodes: true, revealDepth: 2, specialItems: [{ type: 'reforge_ticket', count: 3 }] },
                fail: { text: '一根裂开的骨管吸走魔力，刺耳余音让施法节奏久久无法恢复。', mpRestorePercent: -30, buff: { id: 'discordantEcho', name: '失谐回声', icon: '🎵', color: '#746879', matkPercent: -20, durationBattles: 3 } },
            },
    ...
    plagueSpecimenVault: {
        ...
        choices: [
            {
                id: 'synthesizeAntiserum', label: '智力配血清', description: '按记录净化血清；失败损失25%最大生命并进入5阶段精英战', attribute: 'int', baseRate: 20,
                success: { text: '你从多份污染样本中分离出稳定血清，剩余沉淀也结成了可用魔尘。', hpPotion: 180, mpPotion: 150, specialItems: [{ type: 'magic_dust', count: 700 }], buff: { id: 'plagueAntiserum', name: '净化血清', icon: '🧬', color: '#78a995', defPercent: 20, durationBattles: 3 } },
                fail: { text: '离心瓶爆裂，警报震碎一座培养罐，畸变标本在毒雾中苏醒。', damagePercent: 25, combat: 'elite', forceMonsters: ['mutant3'], encounter: { combatWaves: 5, monstersPerWave: 5, waveComposition: [{ elite: 1, normal: 4 }, { elite: 1, normal: 4 }, { elite: 1, normal: 4 }, { elite: 1, normal: 4 }, { lord: 1, normal: 4 }] } },
            },
            {
                id: 'carrySealedCase', label: '体质搬运', description: '忍受泄漏孢雾，把最完整的样本箱拖出库房', attribute: 'con', baseRate: 15,
                success: { text: '你在孢雾侵入肺部前搬出样本箱，箱内保存着强化结晶、改造凭证和一支应急针剂。', healPercent: 30, specialItems: [{ type: 'enhancement_stone', count: 4 }, { type: 'reforge_ticket', count: 2 }] },
                fail: { text: '样本箱的密封圈在途中脱落，孢雾渗入护甲与呼吸道，让全身力量迅速衰退。', buff: { id: 'plagueExposure', name: '瘟疫暴露', icon: '☣️', color: '#76834f', atkPercent: -20, defPercent: -20, moveSpeedPercent: -15, durationBattles: 3 } },
            },
