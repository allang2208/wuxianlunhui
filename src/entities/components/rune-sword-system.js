export class RuneSwordSystem {
    ...
    trigger() {
        ...
        if (!currentItem || currentItem.weaponId !== 'weapon4') return;
        ...
        this.player._runeSwordSwords.forEach(sword => {
            ...
            entities.forEach(entity => {
                ...
                if (dist < entity.size + 15) {
                    ...
                    const magicDmg = d.magic || 0;
                    const physDmg = this.player.getCurrentWeaponAtk();
                    const damage = Math.floor(magicDmg * 1.2 + physDmg);
    ...
    _end(forced) {
        ...
        this.player._runeSwordSpecialCooldown = 5000; // 5秒冷却
