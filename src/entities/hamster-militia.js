...
export class HamsterMilitia extends Companion {
    constructor(x, y, overrides = {}) {
        ...
        this.hittable = true;
        this.hitFlash = 0;
        // 素材帧内脚底在 ~350/512（非 480），displaySize 226 时脚底距帧中心 41.5px：
        // spriteOffsetY=-42 把脚底贴到逻辑落地点；footOffsetY=42 让深度线 = 逻辑脚底
        this.footOffsetY = 42;
        this.config = { render: { hudOffsetY: 106, footOffsetY: 42 } };
        this._dying = false;
        this._deathTimer = 0;
