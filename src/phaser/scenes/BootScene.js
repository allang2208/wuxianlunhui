...
export class BootScene extends Scene {
    ...
    preload() {
        ...
        // ---- 武器资源 ----
        this.load.image('weapon_rusty_sword', 'assets/weapons/1-rusty_sword_euip.png');
        this.load.image('weapon_knights_sword', 'assets/weapons/knights_sword_v3_equip.png');
        this.load.image('weapon_rune_sword', 'assets/weapons/EXsword_equipped_v2_.png');
        this.load.image('weapon_night_flame', 'assets/weapons/Nightandflame_equip.png');
        this.load.image('weapon_g18', 'assets/weapons/G18equip.png');
        this.load.image('weapon_deagle', 'assets/weapons/DesertEagle_equip.png');
        this.load.image('weapon_pkm', 'assets/weapons/pkm_topdown.png');
        this.load.image('weapon_akm', 'assets/weapons/akm_topdown_lowpoly_v2长枪管.png');
        this.load.image('weapon_qbz191', 'assets/weapons/191equip_clean.png');
        this.load.image('weapon_qjb201', 'assets/weapons/201equip.png');
        this.load.image('weapon_super90', 'assets/weapons/M4s90_equip.png');
        this.load.image('weapon_saiga12k', 'assets/weapons/S12k-equip.png');
        this.load.image('weapon_bow', 'assets/weapons/trainingBOW.png');
