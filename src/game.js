...
export const Game = {
    ...
    spawnMainHubTestEntities() {
        ...
        // 主神空间测试怪已清空（2026-08-16 删除黑狼测试怪；保留清场逻辑）
    },
        ...
        overlay.innerHTML = `
            <div style="background: #2a2520; border: 2px solid #5a4a3a; border-radius: 10px; padding: 30px; max-width: 400px; width: 90%; color: #d4c5a9; text-align: center;">
                ...
                <div style="display: flex; gap: 15px; justify-content: center;">
                    <button id="dungeonEntryConfirmBtn" style="padding: 12px 30px; background: #4a6a3a; border: 2px solid #6a8a5a; color: #d4c5a9; border-radius: 5px; cursor: var(--bp-cursor-pointer, pointer); font-size: 15px;">进入地牢</button>
                    <button id="dungeonEntryCancelBtn" style="padding: 12px 30px; background: #3a3a3a; border: 2px solid #5a5a5a; color: #888; border-radius: 5px; cursor: var(--bp-cursor-pointer, pointer); font-size: 15px;">离开</button>
                </div>
            </div>
        `;
    ...
    _WEAPON_SPAWN_LIST: [
        ...
        EquipDataManager.RPD_ITEM,                     // RPD (weapon31)
        EquipDataManager.M249_ITEM,                    // M249 SAW (weapon32)
        EquipDataManager.ULTIMAX100_ITEM,              // Ultimax 100 Mk8 (weapon33)
        EquipDataManager.MG42_ITEM,                    // MG42 (weapon34)
        EquipDataManager.FUSION_CORE_LMG_ITEM,         // 熔核轻机枪 (weapon35)
        ...
        EquipDataManager.ASTRAL_TIDE_RIFLE_ITEM,       // 星潮协议 (weapon27)
        ...
        EquipDataManager.M1911A1_ITEM,                   // M1911A1 (weapon49)
        EquipDataManager.USP45_ITEM,                     // USP .45 (weapon50)
        EquipDataManager.FIVE_SEVEN_ITEM,                // FN Five-seveN (weapon51)
        EquipDataManager.ETERNAL_EDICT_ITEM,             // 恒星圣谕 (weapon52)
        EquipDataManager.FALCON_EDICT_ITEM,              // 猎隼裁令 (weapon53)
        EquipDataManager.CRIMSON_CROWN_SETTLEMENT_ITEM,  // 赤冕清算 (weapon54)
        EquipDataManager.MYRIAD_CORRIDOR_ITEM,           // 万象回廊 (weapon55)
