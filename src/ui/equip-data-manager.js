...
export const EquipDataManager = {
    ...
    TEST_BACKPACK_ITEMS: [
        ...
        { slot: 3, name: '麦穗', type: '祭品', icon: '🌾', iconImage: 'assets/items/wheat.png', dropImage: 'assets/items/wheat.png', category: 'tribute', stats: [{ name: '金币加成', value: '+25%' }, { name: '生命恢复', value: '+1/秒' }], desc: '一束金色的麦穗，蕴含着丰收的祝福。放入祭品池后，击杀怪物时掉落的金币增加25%，玩家生命值自然恢复每秒加1。', stack: 1, rarity: 'rare', level: 1 },
        { slot: 4, name: '大理石', type: '祭品', icon: '🗿', iconImage: 'assets/items/marble.png', dropImage: 'assets/items/marble.png', category: 'tribute', stats: [{ name: '防御加成', value: '+25%' }, { name: '击杀回血', value: '5%最大生命/秒' }], desc: '一块光滑的大理石，蕴含着大地的守护之力。放入祭品池后，玩家的防御力增加25%，击杀敌方单位后，1秒内回复最大生命值的5%。', stack: 1, rarity: 'epic', level: 1 }
    ],
    TEST_BOW_ITEM: {
