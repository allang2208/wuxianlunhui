...
export const EquipDataManager = {
    ...
    TEST_BACKPACK_ITEMS: [
        ...
        { slot: 4, name: '大理石', type: '祭品', icon: '🗿', iconImage: 'assets/items/大理石.png', dropImage: 'assets/items/大理石.png', category: 'tribute', stats: [{ name: '物理防御', value: '+2%' }, { name: '击杀回血', value: '1%最大生命/秒' }], desc: '一块光滑的大理石，蕴含着大地的守护之力。放入祭品池后，玩家的物理防御增加2%，击杀敌方单位后，1秒内回复最大生命值的1%。', stack: 1, rarity: 'common', level: 1 }
    ],
    G18_PISTOL_ITEM: {
        weaponId: 'weapon9',
