const ShopSystem = {
    ...
    _items: [
        ...
        { id: 'knights_sword', weaponId: 'weapon2', name: '骑士长剑', icon: '⚔', iconImage: 'assets/icons/knights_sword_v3_macro.png', category: 'weapon_melee', rarity: 'uncommon', type: '单手剑', price: 100, equipSlot: 'weapon2', weaponType: 'sword', weaponCategory: 'mainhand', weaponTypeTag: '近战武器', equipImage: 'assets/weapons/knights_sword_v3_equip.png', stats: [{ name: '物理攻击', value: '18-23' }], desc: '骑士团的标准制式长剑，剑身修长，锋利且坚韧。适合有一定基础的剑士使用。', level: 5, attack: { range: 124, knockback: 6, attackInterval: 500, hitType: '突刺（扇形判定）', damageType: '物理' }, animation: { type: 'thrust（突刺）', totalMs: '1100ms (200+500+400)', windupMs: 200, swingMs: 500, recoveryMs: 400, idleAngle: '0°', windupAngle: '+30°', swingAngle: '-30°', holdOffset: '(-20, 11)', weaponSize: 63, timingMul: '1.0x (标准)', description: '三段式突刺动画：预备→前刺→回位。骑士长剑的刺击更加有力，攻击间隔较短。' }, skillOverrides: { dashAttackThrust: { animation: { totalMs: 600, dashDist: 130, chargeMs: 0, thrustMs: 600, recoverMs: 0 }, hitCheck: { shape: 'rectangle', width: 56, length: 263, hitArc: 0 } } } },
        ...
        { id: 'training_bow', weaponId: 'weapon14', name: '训练用弓', icon: '🏹', iconImage: 'assets/icons/trainingBOW.png', equipImage: 'assets/weapons/trainingBOW.png', category: 'weapon_ranged', rarity: 'common', type: '弓', price: 100, equipSlot: 'weapon', weaponType: 'bow', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: true, stats: [{ name: '物理攻击', value: '50-85' }, { name: '射程', value: '1500' }], desc: '一把适合初学者练习的弓，经过改良后拥有更远的射程和更强的威力', level: 1, attack: { range: 1500, projectileSpeed: 30, knockback: 30, attackInterval: 1000, hitType: '箭矢（直线弹道）', damageType: '物理' }, animation: { type: 'frameSequence（帧序列）', totalMs: '1500ms (500+1000+0)', windupMs: 500, swingMs: 1000, recoveryMs: 0, idleAngle: '0°', windupAngle: '0°', swingAngle: '0°', holdOffset: '(-20, 11)', weaponSize: 84, timingMul: '1.0x (标准)', frameCount: 9, framePrefix: 'training_bow_frame_', description: '9帧序列动画：搭箭→拉弓→满弦→发射。播放完毕后箭矢射出。' }, weaponAsset: { framePrefix: 'assets/weapons/training_bow_frame_', frameCount: 9, framePad: 2 } },
        { id: 'steel_bow', name: '精钢长弓', icon: '🏹', iconImage: 'assets/icons/bow_icon.png', category: 'weapon_ranged', rarity: 'uncommon', type: '副武器', price: 100, equipSlot: 'weapon2', weaponType: 'bow', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', dropImage: 'assets/items/steel_bow_dropped.png', stats: [{ name: '物理攻击', value: '15-25' }, { name: '射程', value: '800' }], desc: '由精钢打造的长弓，射程远，威力大', level: 5, attack: { range: 800, knockback: 0, attackInterval: 600, hitType: '箭矢（直线弹道）', damageType: '物理' }, animation: { type: 'frameSequence（帧序列）', totalMs: '800ms (200+250+350)', windupMs: 200, swingMs: 250, recoveryMs: 350, idleAngle: '0°', windupAngle: '+30°', swingAngle: '-30°', holdOffset: '(-20, 11)', weaponSize: 84, timingMul: '1.0x (标准)', frameCount: 8, framePrefix: 'steel_bow_frame_', description: '8帧序列动画：搭箭→拉弓→满弦→发射。精钢长弓的拉弦动作比普通弓更有力。' }, weaponAsset: { framePrefix: 'assets/weapons/steel_bow_frame_', frameCount: 8, framePad: 2 } },
        { id: 'g18', weaponId: 'weapon9', name: 'G18', icon: '🔫', iconImage: 'assets/icons/G18icon.png', category: 'weapon_ranged', rarity: 'rare', type: '手枪', price: 400, equipSlot: 'weapon', weaponType: 'pistol', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: false, dropImage: 'assets/weapons/G18equip.png', equipImage: 'assets/weapons/G18equip.png', slotImage: 'assets/icons/G18icon.png', stats: [{ name: '物理攻击', value: '1-3' }, { name: '射程', value: '650' }], desc: 'G18 全自动手枪，1100发/分钟，淡金色曳光弹，可双持', level: 5, attack: { range: 650, knockback: 0, attackInterval: 55, hitType: '淡金色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 13 }, animation: { type: 'recoil（后坐力抖动）', totalMs: '55ms (约)', windupMs: '≈12', swingMs: '≈18', recoveryMs: '≈25', holdOffset: '(0, 4)', weaponSize: 84, timingMul: '0.06x (极速)', recoilAmount: '0.15rad', description: 'G18 以1100RPM的射速连续射击，单次开火动画仅约55ms。可双持，双持时左右手同时开火。' }, weaponAsset: { image: 'assets/weapons/G18equip.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' } },
        { id: 'pkm', weaponId: 'weapon6', name: 'PKM', icon: '🔫', iconImage: 'assets/icons/pkm_side_clean.png', category: 'weapon_ranged', rarity: 'rare', type: '机枪', price: 500, equipSlot: 'weapon2', weaponType: 'pkm', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: true, dropImage: 'assets/weapons/pkm_topdown.png', stats: [{ name: '物理攻击', value: '10-15' }, { name: '射程', value: '1200' }], desc: 'PKM通用机枪，650发/分钟，亮金色曳光弹，火力压制利器', level: 10, attack: { range: 1200, knockback: 3, attackInterval: 92, hitType: '亮金色曳光弹（直线弹道）', damageType: '物理' }, animation: { type: 'recoil（后坐力抖动）', totalMs: '92ms (约)', windupMs: '≈20', swingMs: '≈30', recoveryMs: '≈42', holdOffset: '(0, 6)', weaponSize: 96, timingMul: '0.1x (高速)', recoilAmount: '0.12rad', description: 'PKM 以650RPM的射速连续射击，单次开火动画约92ms。采用后坐力抖动模式：每次开火枪身快速上扬后回位。timingMul=0.1 确保动画总时长小于92ms的射击间隔。' }, weaponAsset: { image: 'assets/weapons/pkm_topdown.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' } },
        { id: 'akm', weaponId: 'weapon7', name: 'AKM', icon: '🔫', iconImage: 'assets/icons/akm-equip.png', category: 'weapon_ranged', rarity: 'rare', type: '自动步枪', price: 600, equipSlot: 'weapon', weaponType: 'akm', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: true, dropImage: 'assets/weapons/akm_topdown_lowpoly_v2长枪管.png', equipImage: 'assets/weapons/akm-equip.png', slotImage: 'assets/weapons/akm-equip.png', stats: [{ name: '物理攻击', value: '3-6' }, { name: '射程', value: '1200' }], desc: 'AKM自动步枪，600发/分钟，亮金色曳光弹，可靠耐用的经典步枪', level: 10, attack: { range: 1200, knockback: 2, attackInterval: 100, hitType: '亮金色曳光弹（直线弹道）', damageType: '物理' }, animation: { type: 'recoil（后坐力抖动）', totalMs: '100ms (约)', windupMs: '≈20', swingMs: '≈30', recoveryMs: '≈50', holdOffset: '(0, 6)', weaponSize: 96, timingMul: '0.1x (高速)', recoilAmount: '0.12rad', description: 'AKM 以600RPM的射速连续射击，单次开火动画约100ms。采用后坐力抖动模式，与PKM共用相同动画系统。' }, weaponAsset: { image: 'assets/weapons/akm_topdown_lowpoly_v2长枪管.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' } },
        { id: 'qbz191', weaponId: 'weapon8', name: 'QBZ-191', icon: '🔫', iconImage: 'assets/icons/191icon.png', category: 'weapon_ranged', rarity: 'rare', type: '自动步枪', price: 700, equipSlot: 'weapon', weaponType: 'qbz191', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: true, dropImage: 'assets/weapons/191equip_clean.png', equipImage: 'assets/weapons/191equip_clean.png', slotImage: 'assets/weapons/191equip_clean.png', stats: [{ name: '物理攻击', value: '3-6' }, { name: '射程', value: '1200' }], desc: 'QBZ-191自动步枪，850发/分钟，亮金色曳光弹，新一代国产步枪', level: 12, attack: { range: 1200, knockback: 2, attackInterval: 70, hitType: '亮金色曳光弹（直线弹道）', damageType: '物理' }, animation: { type: 'recoil（后坐力抖动）', totalMs: '70ms (约)', windupMs: '≈15', swingMs: '≈20', recoveryMs: '≈35', holdOffset: '(0, 6)', weaponSize: 96, timingMul: '0.07x (高速)', recoilAmount: '0.10rad', description: 'QBZ-191 以850RPM的射速连续射击，单次开火动画约70ms。采用后坐力抖动模式，与PKM/AKM共用相同动画系统。' }, weaponAsset: { image: 'assets/weapons/191equip_clean.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' } },
        { id: 'desert_eagle', weaponId: 'weapon10', name: '沙漠之鹰', icon: '🔫', iconImage: 'assets/icons/DesertEagle_icon.png', category: 'weapon_ranged', rarity: 'epic', type: '手枪', price: 800, equipSlot: 'weapon', weaponType: 'pistol', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: false, dropImage: 'assets/weapons/DesertEagle_equip.png', equipImage: 'assets/weapons/DesertEagle_equip.png', slotImage: 'assets/icons/DesertEagle_icon.png', stats: [{ name: '物理攻击', value: '3-8' }, { name: '射程', value: '750' }], desc: '沙漠之鹰半自动手枪，深黄色曳光弹，可双持，连续开火2秒后计算散布', level: 15, attack: { range: 750, knockback: 10, attackInterval: 800, hitType: '深黄色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 20 }, animation: { type: 'recoil（后坐力抖动）', totalMs: '800ms (约)', windupMs: '≈200', swingMs: '≈300', recoveryMs: '≈300', holdOffset: '(0, 4)', weaponSize: 84, timingMul: '0.5x (慢速)', recoilAmount: '0.10rad', description: '沙漠之鹰以较慢射速开火，单次开火动画约800ms。后坐力抖动幅度较小，与射击频率一致。' }, weaponAsset: { image: 'assets/weapons/DesertEagle_equip.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' } },
        { id: 'qjb201', weaponId: 'weapon11', name: 'QJB-201', icon: '🔫', iconImage: 'assets/icons/201-icon.png', category: 'weapon_ranged', rarity: 'rare', type: '机枪', price: 900, equipSlot: 'weapon', weaponType: 'qjb201', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: true, dropImage: 'assets/weapons/201equip.png', equipImage: 'assets/weapons/201equip.png', slotImage: 'assets/icons/201-icon.png', stats: [{ name: '物理攻击', value: '3-6' }, { name: '射程', value: '1200' }], desc: 'QJB-201班用机枪，1000发/分钟，亮金色曳光弹，轻量化设计的国产机枪，机动性与火力兼备', level: 12, attack: { range: 1200, knockback: 1, attackInterval: 60, hitType: '亮金色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 18 }, animation: { type: 'recoil（后坐力抖动）', totalMs: '60ms (约)', windupMs: '≈12', swingMs: '≈18', recoveryMs: '≈30', holdOffset: '(0, 6)', weaponSize: 96, timingMul: '0.06x (高速)', recoilAmount: '0.08rad', description: 'QJB-201 以1000RPM的射速连续射击，单次开火动画约60ms。采用后坐力抖动模式，轻量化设计带来更小的后坐力。' }, weaponAsset: { image: 'assets/weapons/201equip.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' } },
        { id: 'super90', weaponId: 'weapon12', name: 'Super90', icon: '🔫', iconImage: 'assets/icons/M4s90_icon.png', category: 'weapon_ranged', rarity: 'epic', type: '散弹枪', price: 1200, equipSlot: 'weapon', weaponType: 'shotgun', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: true, dropImage: 'assets/weapons/M4s90_equip.png', equipImage: 'assets/weapons/M4s90_equip.png', slotImage: 'assets/icons/M4s90_icon.png', stats: [{ name: '物理攻击', value: '1-3' }, { name: '射程', value: '500' }], desc: 'Super90 半自动散弹枪，一次击发6发弹丸，单发装填换弹机制，近距离毁灭性火力', level: 15, attack: { range: 500, knockback: 12.5, attackInterval: 333, hitType: '散弹（6发弹丸）', damageType: '物理', projectileSpeed: 25 }, animation: { type: 'recoil（后坐力抖动）', totalMs: '500ms (约)', windupMs: '≈100', swingMs: '≈200', recoveryMs: '≈200', holdOffset: '(0, 6)', weaponSize: 96, timingMul: '0.5x (慢速)', recoilAmount: '0.15rad', description: 'Super90 以较慢射速开火，单次开火动画约500ms。一次击发6发弹丸，近距离毁灭性火力。' }, weaponAsset: { image: 'assets/weapons/M4s90_equip.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' } },
        { id: 'saiga12k', weaponId: 'weapon13', name: 'SAIGA-12K', icon: '🔫', iconImage: 'assets/icons/S12k-icon.png', category: 'weapon_ranged', rarity: 'epic', type: '散弹枪', price: 1500, equipSlot: 'weapon', weaponType: 'shotgun', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: true, dropImage: 'assets/weapons/S12k-equip.png', equipImage: 'assets/weapons/S12k-equip.png', slotImage: 'assets/icons/S12k-icon.png', stats: [{ name: '物理攻击', value: '1-3' }, { name: '射程', value: '400' }], desc: 'SAIGA-12K 半自动散弹枪，一次击发4发弹丸，正常弹夹换弹，高射速近距离火力', level: 15, attack: { range: 400, knockback: 12.5, attackInterval: 150, hitType: '散弹（4发弹丸）', damageType: '物理', projectileSpeed: 15 }, animation: { type: 'recoil（后坐力抖动）', totalMs: '150ms (约)', windupMs: '≈30', swingMs: '≈60', recoveryMs: '≈60', holdOffset: '(0, 6)', weaponSize: 96, timingMul: '0.15x (高速)', recoilAmount: '0.15rad', description: 'SAIGA-12K 以高射速开火，单次开火动画约150ms。一次击发4发弹丸，散布±20°。' }, weaponAsset: { image: 'assets/weapons/S12k-equip.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' } }
    ],
