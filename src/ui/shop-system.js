...
const ShopSystem = {
    ...
    SHOP_CATALOGS: {
        ...
        { id: 'revolver357', weaponId: 'weapon22', name: '.357麦格农左轮', icon: '🔫', iconImage: 'assets/icons/revolver357-equip.png', category: 'weapon_ranged', rarity: 'epic', type: '手枪', price: 800, equipSlot: 'weapon', weaponType: 'pistol', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: false, dropImage: 'assets/weapons/revolver357-equip.png', equipImage: 'assets/weapons/revolver357-equip.png', slotImage: 'assets/icons/revolver357-equip.png', stats: [{ name: '物理攻击', value: '4-9' }, { name: '射程', value: '700' }], desc: '.357麦格农左轮手枪，6发弹巢，亮银色曳光弹，威力巨大的经典左轮', level: 15, attack: { range: 700, knockback: 12, attackInterval: 700, hitType: '亮银色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 1248 }, animation: { type: 'recoil（后坐力抖动）', totalMs: '700ms (约)', windupMs: '≈175', swingMs: '≈250', recoveryMs: '≈275', holdOffset: '(0, 4)', weaponSize: 84, timingMul: '0.5x (慢速)', recoilAmount: '0.12rad', description: '.357麦格农左轮以较慢射速开火，单次开火动画约700ms。后坐力抖动幅度较大，与射击频率一致。' }, weaponAsset: { image: 'assets/weapons/revolver357-equip.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' }, attackKey: 'revolver', offhandAttackKey: 'revolverOffhand', animConfigKey: 'revolver', fireSound: 'assets/sounds/weapons/revolver357_fire.wav', equipSound: 'assets/sounds/weapons/revolver357_equip.wav', canvasImageProp: 'revolverImage', ammoConfig: { max: 6, reloadTime: 2000, reloadSound: 'assets/sounds/weapons/revolver357_reload.wav' }, fireMode: 'semiAuto', attackFormula: { base: 26, enhanceFlat: 0, attrs: [{ key: 'dex', base: 0.8, perEnhance: 0.1 }, { key: 'wis', base: 1.6, perEnhance: 0.15 }] }, spreadParams: { startDelay: 500, maxTime: 4000, maxAngle: 28 } },
