...
const ShopSystem = {
    ...
    _items: [
        ...
        { id: 'beretta93r', weaponId: 'weapon19', name: 'Beretta 93R', icon: '🔫', iconImage: 'assets/weapons/beretta93r.png', category: 'weapon_ranged', rarity: 'uncommon', type: '手枪', price: 300, equipSlot: 'weapon', weaponType: 'pistol', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: false, dropImage: 'assets/weapons/beretta93r.png', equipImage: 'assets/weapons/beretta93r.png', slotImage: 'assets/weapons/beretta93r.png', stats: [{ name: '物理攻击', value: '8+敏捷×0.5+精神×0.5' }, { name: '射程', value: '700' }], desc: 'Beretta 93R 半自动手枪，9发弹夹，可双持，扳机位可改造三连发/全自动', level: 8, attack: { range: 700, knockback: 0, attackInterval: 225, hitType: '淡金色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 800 }, animation: { type: 'recoil（后坐力抖动）', totalMs: '225ms (约)', windupMs: '≈56', swingMs: '≈75', recoveryMs: '≈94', holdOffset: '(0, 4)', weaponSize: 84, timingMul: '0.5x (慢速)', recoilAmount: '0.08rad', description: 'Beretta 93R 以 225ms 间隔半自动射击，可双持，扳机位可改造三连发/全自动。' }, weaponAsset: { image: 'assets/weapons/beretta93r.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' }, attackKey: 'beretta93r', offhandAttackKey: 'beretta93rOffhand', animConfigKey: 'beretta93r', fireSound: 'assets/sounds/weapons/apex2_shot_1s.wav', isDarkGold: true, canvasImageProp: 'beretta93rImage', ammoConfig: { max: 9, reloadTime: 1500 }, fireMode: 'semiAuto', attackFormula: { base: 8, enhanceFlat: 0.75, attrs: [{ key: 'dex', base: 0.5, perEnhance: 0.1 }, { key: 'wis', base: 0.5, perEnhance: 0.15 }] }, spreadParams: { startDelay: 0, maxTime: 0, maxAngle: 5 } },
