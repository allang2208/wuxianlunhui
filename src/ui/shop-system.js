...
const ShopSystem = {
    ...
    SHOP_CATALOGS: {
        ...
        { id: 'g18', weaponId: 'weapon9', name: 'G18', icon: '🔫', iconImage: 'assets/icons/G18icon.png', category: 'weapon_ranged', rarity: 'rare', type: '手枪', price: 400, equipSlot: 'weapon', weaponType: 'pistol', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: false, dropImage: 'assets/icons/G18icon.png', equipImage: 'assets/icons/G18icon.png', slotImage: 'assets/icons/G18icon.png', stats: [{ name: '物理攻击', value: '1-3' }, { name: '射程', value: '650' }], desc: 'G18 全自动手枪，1100发/分钟，淡金色曳光弹，可双持', level: 5, attack: { range: 650, knockback: 0, attackInterval: 55, hitType: '淡金色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 1248 }, animation: { type: 'recoil（后坐力抖动）', totalMs: '55ms (约)', windupMs: '≈12', swingMs: '≈18', recoveryMs: '≈25', holdOffset: '(0, 4)', weaponSize: 84, timingMul: '0.06x (极速)', recoilAmount: '0.15rad', description: 'G18 以1100RPM的射速连续射击，单次开火动画仅约55ms。可双持，双持时左右手同时开火。' }, weaponAsset: { image: 'assets/icons/G18icon.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' }, attackKey: 'pistol', offhandAttackKey: 'pistolOffhand', animConfigKey: 'pistol', fireSound: 'assets/sounds/weapons/akm_burst.mp3', isDarkGold: false, canvasImageProp: 'pistolImage', ammoConfig: { max: 12, reloadTime: 1000 }, fireMode: 'fullAuto', attackFormula: { base: 5, enhanceFlat: 1, attrs: [{ key: 'dex', base: 0.35, perEnhance: 0.15 }, { key: 'wis', base: 0.4, perEnhance: 0.15 }] }, spreadParams: { startDelay: 0, maxTime: 300, maxAngle: 25 } },
        { id: 'p4040', weaponId: 'weapon18', name: 'P4040', icon: '🔫', iconImage: 'assets/weapons/P4040-icon.png', category: 'weapon_ranged', rarity: 'epic', type: '手枪', price: 600, equipSlot: 'weapon', weaponType: 'pistol', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: false, dropImage: 'assets/weapons/P4040-icon.png', equipImage: 'assets/weapons/P4040-icon.png', slotImage: 'assets/weapons/P4040-icon.png', stats: [{ name: '物理攻击', value: '2-4' }, { name: '射程', value: '750' }], desc: 'P4040半自动手枪，可双持，精准射击', level: 15, attack: { range: 750, knockback: 2, attackInterval: 300, hitType: '淡金色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 1248, bulletSpeed: 1248 }, animation: { type: 'recoil（后坐力抖动）', totalMs: '300ms (约)', windupMs: '≈75', swingMs: '≈100', recoveryMs: '≈125', holdOffset: '(0, 4)', weaponSize: 84, timingMul: '0.5x (慢速)', recoilAmount: '0.08rad', description: 'P4040 以较慢射速开火，单次开火动画约300ms。后坐力抖动幅度较小，与射击频率一致。' }, weaponAsset: { image: 'assets/weapons/P4040-icon.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' }, attackKey: 'p4040', offhandAttackKey: 'p4040Offhand', animConfigKey: 'p4040', fireSound: 'assets/sounds/weapons/apex2_shot_1s.wav', isDarkGold: true, canvasImageProp: 'p4040Image', ammoConfig: { max: 12, reloadTime: 1200 }, fireMode: 'semiAuto', attackFormula: { base: 8, enhanceFlat: 1, attrs: [{ key: 'dex', base: 0.75, perEnhance: 0.15 }, { key: 'wis', base: 1, perEnhance: 0.25 }] }, spreadParams: { startDelay: 0, maxTime: 0, maxAngle: 1 } },
        { id: 'beretta93r', weaponId: 'weapon19', name: 'Beretta 93R', icon: '🔫', iconImage: 'assets/weapons/beretta93r.png', category: 'weapon_ranged', rarity: 'uncommon', type: '手枪', price: 300, equipSlot: 'weapon', weaponType: 'pistol', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: false, dropImage: 'assets/weapons/beretta93r.png', equipImage: 'assets/weapons/beretta93r.png', slotImage: 'assets/weapons/beretta93r.png', stats: [{ name: '物理攻击', value: '8+敏捷×0.5+精神×0.5' }, { name: '射程', value: '700' }], desc: 'Beretta 93R 半自动手枪，9发弹夹，可双持，扳机位可改造三连发/全自动', level: 8, attack: { range: 700, knockback: 0, attackInterval: 225, hitType: '淡金色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 800 }, animation: { type: 'recoil（后坐力抖动）', totalMs: '225ms (约)', windupMs: '≈56', swingMs: '≈75', recoveryMs: '≈94', holdOffset: '(0, 4)', weaponSize: 84, timingMul: '0.5x (慢速)', recoilAmount: '0.08rad', description: 'Beretta 93R 以 225ms 间隔半自动射击，可双持，扳机位可改造三连发/全自动。' }, weaponAsset: { image: 'assets/weapons/beretta93r.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' }, attackKey: 'beretta93r', offhandAttackKey: 'beretta93rOffhand', animConfigKey: 'beretta93r', fireSound: 'assets/sounds/weapons/beretta93r_fire.mp3', isDarkGold: true, canvasImageProp: 'beretta93rImage', ammoConfig: { max: 9, reloadTime: 1500 }, fireMode: 'semiAuto', attackFormula: { base: 8, enhanceFlat: 0.75, attrs: [{ key: 'dex', base: 0.5, perEnhance: 0.1 }, { key: 'wis', base: 0.5, perEnhance: 0.15 }] }, spreadParams: { startDelay: 0, maxTime: 0, maxAngle: 5 } },
        { id: 'pkm', weaponId: 'weapon6', name: 'PKM', icon: '🔫', iconImage: 'assets/icons/pkm_side_clean.png', category: 'weapon_ranged', rarity: 'rare', type: '机枪', price: 500, equipSlot: 'weapon2', weaponType: 'pkm', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: true, dropImage: 'assets/icons/pkm_side_clean.png', stats: [{ name: '物理攻击', value: '10+力量×0.5+精神×0.4' }, { name: '射程', value: '1200' }], desc: 'PKM通用机枪，650发/分钟，亮金色曳光弹，火力压制利器', level: 10, attack: { range: 1200, knockback: 3, attackInterval: 92, hitType: '亮金色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 1248 }, attackFormula: { base: 10, enhanceFlat: 1, attrs: [{ key: 'str', base: 0.5, perEnhance: 0.15 }, { key: 'wis', base: 0.4, perEnhance: 0.12 }] }, animation: { type: 'recoil（后坐力抖动）', totalMs: '92ms (约)', windupMs: '≈20', swingMs: '≈30', recoveryMs: '≈42', holdOffset: '(0, 6)', weaponSize: 96, timingMul: '0.1x (高速)', recoilAmount: '0.12rad', description: 'PKM 以650RPM的射速连续射击，单次开火动画约92ms。采用后坐力抖动模式：每次开火枪身快速上扬后回位。timingMul=0.1 确保动画总时长小于92ms的射击间隔。' }, weaponAsset: { image: 'assets/icons/pkm_side_clean.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' } },
        { id: 'akm', weaponId: 'weapon7', name: 'AKM', icon: '🔫', iconImage: 'assets/icons/akm-equip.png', category: 'weapon_ranged', rarity: 'rare', type: '自动步枪', price: 600, equipSlot: 'weapon', weaponType: 'akm', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: true, dropImage: 'assets/weapons/akm-equip.png', equipImage: 'assets/weapons/akm-equip.png', slotImage: 'assets/weapons/akm-equip.png', stats: [{ name: '物理攻击', value: '3-6' }, { name: '射程', value: '1200' }], desc: 'AKM自动步枪，600发/分钟，亮金色曳光弹，可靠耐用的经典步枪', level: 10, attack: { range: 1200, knockback: 2, attackInterval: 100, hitType: '亮金色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 1248 }, animation: { type: 'recoil（后坐力抖动）', totalMs: '100ms (约)', windupMs: '≈20', swingMs: '≈30', recoveryMs: '≈50', holdOffset: '(0, 6)', weaponSize: 96, timingMul: '0.1x (高速)', recoilAmount: '0.12rad', description: 'AKM 以600RPM的射速连续射击，单次开火动画约100ms。采用后坐力抖动模式，与PKM共用相同动画系统。' }, weaponAsset: { image: 'assets/weapons/akm-equip.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' } },
        { id: 'm416', weaponId: 'weapon21', name: 'M416', icon: '🔫', iconImage: 'assets/icons/m416-equip.png', category: 'weapon_ranged', rarity: 'uncommon', type: '自动步枪', price: 450, equipSlot: 'weapon', weaponType: 'm416', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: true, dropImage: 'assets/weapons/m416-equip.png', equipImage: 'assets/weapons/m416-equip.png', slotImage: 'assets/icons/m416-equip.png', stats: [{ name: '物理攻击', value: '3-5' }, { name: '射程', value: '1150' }], desc: 'M416自动步枪，750发/分钟，亮金色曳光弹，均衡可靠的模块化步枪', level: 8, attack: { range: 1150, knockback: 2, attackInterval: 110, hitType: '亮金色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 1248 }, animation: { type: 'recoil（后坐力抖动）', totalMs: '110ms (约)', windupMs: '≈22', swingMs: '≈33', recoveryMs: '≈55', holdOffset: '(0, 6)', weaponSize: 96, timingMul: '0.11x (高速)', recoilAmount: '0.11rad', description: 'M416 以750RPM的射速连续射击，单次开火动画约110ms。采用后坐力抖动模式，与PKM/AKM共用相同动画系统。' }, weaponAsset: { image: 'assets/weapons/m416-equip.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' }, attackKey: 'm416', animConfigKey: 'm416', fireSound: 'assets/sounds/weapons/m416_fire.wav', equipSound: 'assets/sounds/weapons/m416_equip.wav', canvasImageProp: 'm416Image', ammoConfig: { max: 30, reloadTime: 1200, reloadSound: 'assets/sounds/weapons/m416_reload.wav' }, fireMode: 'fullAuto', attackFormula: { base: 8, enhanceFlat: 0.8, attrs: [{ key: 'int', base: 0.4, perEnhance: 0.1 }, { key: 'wis', base: 0.4, perEnhance: 0.1 }] }, spreadParams: { startDelay: 500, maxTime: 4000, maxAngle: 25 } },
        { id: 'qbz191', weaponId: 'weapon8', name: 'QBZ-191', icon: '🔫', iconImage: 'assets/icons/191icon.png', category: 'weapon_ranged', rarity: 'rare', type: '自动步枪', price: 700, equipSlot: 'weapon', weaponType: 'qbz191', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: true, dropImage: 'assets/icons/191icon.png', equipImage: 'assets/icons/191icon.png', slotImage: 'assets/icons/191icon.png', stats: [{ name: '物理攻击', value: '3-6' }, { name: '射程', value: '1200' }], desc: 'QBZ-191自动步枪，850发/分钟，亮金色曳光弹，新一代国产步枪', level: 12, attack: { range: 1200, knockback: 2, attackInterval: 70, hitType: '亮金色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 1248 }, animation: { type: 'recoil（后坐力抖动）', totalMs: '70ms (约)', windupMs: '≈15', swingMs: '≈20', recoveryMs: '≈35', holdOffset: '(0, 6)', weaponSize: 96, timingMul: '0.07x (高速)', recoilAmount: '0.10rad', description: 'QBZ-191 以850RPM的射速连续射击，单次开火动画约70ms。采用后坐力抖动模式，与PKM/AKM共用相同动画系统。' }, weaponAsset: { image: 'assets/icons/191icon.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' } },
        { id: 'desert_eagle', weaponId: 'weapon10', name: '沙漠之鹰', icon: '🔫', iconImage: 'assets/icons/DesertEagle_icon.png', category: 'weapon_ranged', rarity: 'epic', type: '手枪', price: 800, equipSlot: 'weapon', weaponType: 'pistol', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: false, dropImage: 'assets/icons/DesertEagle_icon.png', equipImage: 'assets/icons/DesertEagle_icon.png', slotImage: 'assets/icons/DesertEagle_icon.png', stats: [{ name: '物理攻击', value: '3-8' }, { name: '射程', value: '750' }], desc: '沙漠之鹰半自动手枪，深黄色曳光弹，可双持，连续开火2秒后计算散布', level: 15, attack: { range: 750, knockback: 10, attackInterval: 800, hitType: '深黄色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 1248 }, animation: { type: 'recoil（后坐力抖动）', totalMs: '800ms (约)', windupMs: '≈200', swingMs: '≈300', recoveryMs: '≈300', holdOffset: '(0, 4)', weaponSize: 84, timingMul: '0.5x (慢速)', recoilAmount: '0.10rad', description: '沙漠之鹰以较慢射速开火，单次开火动画约800ms。后坐力抖动幅度较小，与射击频率一致。' }, weaponAsset: { image: 'assets/icons/DesertEagle_icon.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' }, attackKey: 'deagle', offhandAttackKey: 'deagleOffhand', animConfigKey: 'deagle', fireSound: 'assets/sounds/weapons/cs_deagle_35_80.wav', isDarkGold: true, canvasImageProp: 'deagleImage', ammoConfig: { max: 6, reloadTime: 1750 }, fireMode: 'semiAuto', attackFormula: { base: 30, enhanceFlat: 0, attrs: [{ key: 'dex', base: 1, perEnhance: 0 }, { key: 'wis', base: 2, perEnhance: 0 }] }, spreadParams: { startDelay: 500, maxTime: 4000, maxAngle: 30 } },
        { id: 'revolver357', weaponId: 'weapon22', name: '.357麦格农左轮', icon: '🔫', iconImage: 'assets/icons/revolver357-equip.png', category: 'weapon_ranged', rarity: 'epic', type: '手枪', price: 800, equipSlot: 'weapon', weaponType: 'pistol', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: false, dropImage: 'assets/weapons/revolver357-equip.png', equipImage: 'assets/weapons/revolver357-equip.png', slotImage: 'assets/icons/revolver357-equip.png', stats: [{ name: '物理攻击', value: '4-9' }, { name: '射程', value: '700' }], desc: '.357麦格农左轮手枪，6发弹巢，亮银色曳光弹，单发装填换弹机制，威力巨大的经典左轮', level: 15, attack: { range: 700, knockback: 12, attackInterval: 700, hitType: '亮银色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 1248 }, animation: { type: 'recoil（后坐力抖动）', totalMs: '700ms (约)', windupMs: '≈175', swingMs: '≈250', recoveryMs: '≈275', holdOffset: '(0, 4)', weaponSize: 84, timingMul: '0.5x (慢速)', recoilAmount: '0.12rad', description: '.357麦格农左轮以较慢射速开火，单次开火动画约700ms。后坐力抖动幅度较大，与射击频率一致。' }, weaponAsset: { image: 'assets/weapons/revolver357-equip.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' }, attackKey: 'revolver', offhandAttackKey: 'revolverOffhand', animConfigKey: 'revolver', fireSound: 'assets/sounds/weapons/revolver357_fire.mp3', equipSound: 'assets/sounds/weapons/revolver357_equip.wav', canvasImageProp: 'revolverImage', ammoConfig: { max: 6, reloadTime: 900, singleReloadMode: true, reloadSound: 'assets/sounds/weapons/revolver357_reload.wav', reloadFinishSound: 'assets/sounds/weapons/revolver357_reload_last.wav' }, fireMode: 'semiAuto', attackFormula: { base: 26, enhanceFlat: 0, attrs: [{ key: 'dex', base: 0.8, perEnhance: 0.1 }, { key: 'wis', base: 1.6, perEnhance: 0.15 }] }, spreadParams: { startDelay: 500, maxTime: 4000, maxAngle: 28 } },
        { id: 'qjb201', weaponId: 'weapon11', name: 'QJB-201', icon: '🔫', iconImage: 'assets/icons/201-icon.png', category: 'weapon_ranged', rarity: 'rare', type: '机枪', price: 900, equipSlot: 'weapon', weaponType: 'qjb201', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: true, dropImage: 'assets/icons/201-icon.png', equipImage: 'assets/icons/201-icon.png', slotImage: 'assets/icons/201-icon.png', stats: [{ name: '物理攻击', value: '7+力量×0.35+精神×0.5' }, { name: '射程', value: '1200' }], desc: 'QJB-201班用机枪，1000发/分钟，亮金色曳光弹，轻量化设计的国产机枪，机动性与火力兼备', level: 12, attack: { range: 1200, knockback: 1, attackInterval: 60, hitType: '亮金色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 1248 }, attackFormula: { base: 7, enhanceFlat: 1, attrs: [{ key: 'str', base: 0.35, perEnhance: 0.10 }, { key: 'wis', base: 0.5, perEnhance: 0.15 }] }, animation: { type: 'recoil（后坐力抖动）', totalMs: '60ms (约)', windupMs: '≈12', swingMs: '≈18', recoveryMs: '≈30', holdOffset: '(0, 6)', weaponSize: 96, timingMul: '0.06x (高速)', recoilAmount: '0.08rad', description: 'QJB-201 以1000RPM的射速连续射击，单次开火动画约60ms。采用后坐力抖动模式，轻量化设计带来更小的后坐力。' }, weaponAsset: { image: 'assets/icons/201-icon.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' } },
        { id: 'super90', weaponId: 'weapon12', name: 'Super90', icon: '🔫', iconImage: 'assets/icons/M4s90_icon.png', category: 'weapon_ranged', rarity: 'epic', type: '散弹枪', price: 1200, equipSlot: 'weapon', weaponType: 'shotgun', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: true, dropImage: 'assets/icons/M4s90_icon.png', equipImage: 'assets/icons/M4s90_icon.png', slotImage: 'assets/icons/M4s90_icon.png', stats: [{ name: '物理攻击', value: '1-3' }, { name: '射程', value: '500' }], desc: 'Super90 半自动散弹枪，一次击发6发弹丸，单发装填换弹机制，近距离毁灭性火力', level: 15, attack: { range: 500, knockback: 12.5, attackInterval: 333, hitType: '散弹（6发弹丸）', damageType: '物理', projectileSpeed: 1248 }, animation: { type: 'recoil（后坐力抖动）', totalMs: '500ms (约)', windupMs: '≈100', swingMs: '≈200', recoveryMs: '≈200', holdOffset: '(0, 6)', weaponSize: 96, timingMul: '0.5x (慢速)', recoilAmount: '0.15rad', description: 'Super90 以较慢射速开火，单次开火动画约500ms。一次击发6发弹丸，近距离毁灭性火力。' }, ammoConfig: { max: 7, reloadTime: 400, singleReloadMode: true, reloadSound: 'assets/sounds/weapons/Super90-reload.mp3' }, equipSound: 'assets/sounds/weapons/bolt_pull_1s_clean.wav', weaponAsset: { image: 'assets/icons/M4s90_icon.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' } },
        { id: 'saiga12k', weaponId: 'weapon13', name: 'SAIGA-12K', icon: '🔫', iconImage: 'assets/icons/S12k-icon.png', category: 'weapon_ranged', rarity: 'epic', type: '散弹枪', price: 1500, equipSlot: 'weapon', weaponType: 'shotgun', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: true, dropImage: 'assets/icons/S12k-icon.png', equipImage: 'assets/icons/S12k-icon.png', slotImage: 'assets/icons/S12k-icon.png', stats: [{ name: '物理攻击', value: '1-3' }, { name: '射程', value: '400' }], desc: 'SAIGA-12K 半自动散弹枪，一次击发4发弹丸，正常弹夹换弹，高射速近距离火力', level: 15, attack: { range: 400, knockback: 12.5, attackInterval: 150, hitType: '散弹（4发弹丸）', damageType: '物理', projectileSpeed: 1248 }, animation: { type: 'recoil（后坐力抖动）', totalMs: '150ms (约)', windupMs: '≈30', swingMs: '≈60', recoveryMs: '≈60', holdOffset: '(0, 6)', weaponSize: 96, timingMul: '0.15x (高速)', recoilAmount: '0.15rad', description: 'SAIGA-12K 以高射速开火，单次开火动画约150ms。一次击发4发弹丸，散布±20°。' }, weaponAsset: { image: 'assets/icons/S12k-icon.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' } },
        { id: 'energy_lmg', weaponId: 'weapon15', name: '能量轻机枪', icon: '🔫', iconImage: 'assets/icons/devotion-icon.png', category: 'weapon_ranged', rarity: 'epic', type: '机枪', price: 2000, equipSlot: 'weapon', weaponType: 'energy_lmg', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: true, dropImage: 'assets/icons/devotion-icon.png', equipImage: 'assets/icons/devotion-icon.png', slotImage: 'assets/icons/devotion-icon.png', stats: [{ name: '魔法攻击', value: '6+力量/精神' }, { name: '射程', value: '1200' }], desc: '能量轻机枪，无限子弹，亮绿色曳光弹，持续开火射速线性提升，过热冷却系统', level: 15, attack: { range: 1200, knockback: 0, attackInterval: 333, hitType: '亮绿色曳光弹（直线弹道）', damageType: '魔法', projectileSpeed: 1248 }, animation: { type: 'recoil（后坐力抖动）', totalMs: '333ms (约)', windupMs: '≈50', swingMs: '≈75', recoveryMs: '≈125', holdOffset: '(0, 6)', weaponSize: 96, timingMul: '0.25x (高速)', recoilAmount: '0.10rad', description: '能量轻机枪以可变射速连续射击，初始333ms间隔，持续开火后逐渐加速至50ms。采用后坐力抖动模式，亮绿色曳光弹。' }, weaponAsset: { image: 'assets/icons/devotion-icon.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' }, energyLMGParams: { baseCooldown: 333, maxCooldown: 50, rampUpTime: 2500, overheatTime: 4000, overheatRecoverTime: 2500, overheatCooldownTime: 4000, spreadMaxTime: 2500, maxSpreadAngle: 15 } },
        ...
        { id: 'anchorTokenF', name: 'F 级时空锚点代币', icon: '🌀', category: 'tribute', rarity: 'common', type: '地牢钥匙', price: 100, shopPrice: 200, shopOnly: true, stats: [{ name: '用途', value: 'F 级地牢钥匙' }], desc: 'F 级地牢钥匙。出征时自动从背包或仓库消耗 1 枚，不能献祭。', stack: 1, maxStack: 999 },
        { id: 'anchorTokenE', name: 'E 级时空锚点代币', icon: '🌀', category: 'tribute', rarity: 'uncommon', type: '地牢钥匙', price: 200, shopPrice: 400, shopOnly: true, stats: [{ name: '用途', value: 'E 级地牢钥匙' }], desc: 'E 级地牢钥匙。出征时自动从背包或仓库消耗 1 枚，不能献祭。', stack: 1, maxStack: 999 },
        { id: 'anchorTokenD', name: 'D 级时空锚点代币', icon: '🌀', category: 'tribute', rarity: 'rare', type: '地牢钥匙', price: 400, shopPrice: 800, shopOnly: true, stats: [{ name: '用途', value: 'D 级地牢钥匙' }], desc: 'D 级地牢钥匙。出征时自动从背包或仓库消耗 1 枚，不能献祭。', stack: 1, maxStack: 999 },
        { id: 'anchorTokenC', name: 'C 级时空锚点代币', icon: '🌀', category: 'tribute', rarity: 'epic', type: '地牢钥匙', price: 800, shopPrice: 1600, shopOnly: true, stats: [{ name: '用途', value: 'C 级地牢钥匙' }], desc: 'C 级地牢钥匙。出征时自动从背包或仓库消耗 1 枚，不能献祭。', stack: 1, maxStack: 999 },
        { id: 'anchorTokenB', name: 'B 级时空锚点代币', icon: '🌀', category: 'tribute', rarity: 'mythic', type: '地牢钥匙', price: 1600, shopPrice: 3200, shopOnly: true, stats: [{ name: '用途', value: 'B 级地牢钥匙' }], desc: 'B 级地牢钥匙。出征时自动从背包或仓库消耗 1 枚，不能献祭。', stack: 1, maxStack: 999 },
        { id: 'anchorTokenA', name: 'A 级时空锚点代币', icon: '🌀', category: 'tribute', rarity: 'legendary', type: '地牢钥匙', price: 3200, shopPrice: 6400, shopOnly: true, stats: [{ name: '用途', value: 'A 级地牢钥匙' }], desc: 'A 级地牢钥匙。出征时自动从背包或仓库消耗 1 枚，不能献祭。', stack: 1, maxStack: 999 }
        ],
