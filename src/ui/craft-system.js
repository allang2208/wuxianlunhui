...
const CraftSystem = {
    ...
    _WEAPON_CRAFT_CONFIGS: {
        weapon2: {
            slots: [
                { id: 'blade', name: '剑刃', x: 0.08, y: 0.12, lineTarget: { x: 0.50, y: 0.30 } },
                { id: 'guard', name: '护手', x: 0.08, y: 0.42, lineTarget: { x: 0.50, y: 0.45 } },
                { id: 'grip', name: '握把', x: 0.50, y: 0.72, lineTarget: { x: 0.50, y: 0.55 } },
                { id: 'blade_body_1', name: '剑身', x: 0.92, y: 0.12, lineTarget: { x: 0.50, y: 0.35 } },
                { id: 'blade_body_2', name: '剑身', x: 0.92, y: 0.40, lineTarget: { x: 0.50, y: 0.40 } },
                { id: 'pommel', name: '配重', x: 0.92, y: 0.70, lineTarget: { x: 0.50, y: 0.60 } },
            ],
            options: {
                blade: [
