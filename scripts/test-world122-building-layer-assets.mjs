...
const items = [
    ['barracks', { displayW: 288, displayH: 230, foot: 115 }],
    ['church', { displayW: 256, displayH: 250, foot: 125 }],
    ['research_institute', { displayW: 288, displayH: 277, foot: 139 }],
    ['thatch_hut', { displayW: 288, displayH: 231, foot: 116 }],
    ['blacksmith', { displayW: 288, displayH: 276, foot: 138 }],
    ['shooting_range', { displayW: 288, displayH: 272, foot: 136 }],
];
...
for (const [key, expected] of items) {
    ...
    check(`${key} 贴图居中贴底、显示锚点与投影资产一致`,
        centered && bottomAligned && expectedH === expected.displayH && expected.foot === Math.round(expected.displayH / 2)
