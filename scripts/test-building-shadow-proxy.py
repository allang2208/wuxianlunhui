...
class BuildingShadowProxyTests(unittest.TestCase):
    def setUp(self):
        self.records = [
            ...
            # 新增柱未写 shadow_role 时，导出器/核心都必须按主体接入，不能静默漏影。
            rectangle("NewColumn", None, 220, -45, 280, 45, 20, 420),
    ...
    def test_foundation_is_excluded_and_unmarked_new_column_is_automatic_part(self):
        result = self.build()
