...
|---|---|---|---|---|
| F | 普通及以上 | 稀有 | 2% | 僵尸：collapsedArchway(F)、undeadScholarNotes(E)、mistyCrossroad(E)、poisonMushroomCircle(F)；沼泽：—（仅通用事件） |
| E | 优质及以上 | 史诗 | 2.5% | 僵尸：collapsedArchway(F)、undeadScholarNotes(E)、bloodAltar(D)、mistyCrossroad(E)、cursedArmor(D)、poisonMushroomCircle(F)、blessedFountain(D)；沼泽：swampEventPlaceholder(D) |
| D | 稀有及以上 | 传说 | 3% | 僵尸：undeadScholarNotes(E)、bloodAltar(D)、mistyCrossroad(E)、cursedArmor(D)、abyssalGambler(C)、blessedFountain(D)、lockedArmory(C)；沼泽：swampEventPlaceholder(D) |
| C | 史诗及以上 | 传说 | 3.5% | 僵尸：bloodAltar(D)、cursedArmor(D)、abyssalGambler(C)、blessedFountain(D)、lockedArmory(C)、phantomMirror(B)；沼泽：swampEventPlaceholder(D) |
| B | 神话及以上 | 传说 | 4% | 僵尸：abyssalGambler(C)、lockedArmory(C)、phantomMirror(B)；沼泽：—（仅通用事件） |
| A | 传说及以上 | 传说 | 4.5% | 僵尸：phantomMirror(B)；沼泽：—（仅通用事件） |
