const ShopSystem = {
    ...
    _items: [
        ...
        { id: 'desert_eagle', weaponId: 'weapon10', name: '沙漠之鹰', icon: '🔫', iconImage: 'assets/icons/DesertEagle_icon.png', category: 'weapon_ranged', rarity: 'epic', type: '手枪', price: 800, equipSlot: 'weapon', weaponType: 'pistol', weaponCategory: 'mainhand', weaponTypeTag: '远程武器', isTwoHanded: false, dropImage: 'assets/weapons/DesertEagle_equip.png', equipImage: 'assets/weapons/DesertEagle_equip.png', slotImage: 'assets/icons/DesertEagle_icon.png', stats: [{ name: '物理攻击', value: '3-8' }, { name: '射程', value: '750' }], desc: '沙漠之鹰半自动手枪，深黄色曳光弹，可双持，连续开火2秒后计算散布', level: 15, attack: { range: 750, knockback: 10, attackInterval: 800, hitType: '深黄色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 3120 }, animation: { type: 'recoil（后坐力抖动）', totalMs: '800ms (约)', windupMs: '≈200', swingMs: '≈300', recoveryMs: '≈300', holdOffset: '(0, 4)', weaponSize: 84, timingMul: '0.5x (慢速)', recoilAmount: '0.10rad', description: '沙漠之鹰以较慢射速开火，单次开火动画约800ms。后坐力抖动幅度较小，与射击频率一致。' }, weaponAsset: { image: 'assets/weapons/DesertEagle_equip.png', muzzleImage: 'assets/effects/muzzle_flash_01.png' } },
