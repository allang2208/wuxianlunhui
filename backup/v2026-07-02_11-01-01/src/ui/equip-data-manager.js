...
export const EquipDataManager = {
    ...
    G18_PISTOL_ITEM: {
        ...
        equipSlot: 'weapon',
        attack: { range: 650, knockback: 0, attackInterval: 55, hitType: '淡金色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 2028 },
    ...
    DESERT_EAGLE_ITEM: {
        ...
        equipSlot: 'weapon',
        attack: { range: 750, knockback: 10, attackInterval: 800, hitType: '深黄色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 3120 },
        attackKey: 'deagle', offhandAttackKey: 'deagleOffhand', animConfigKey: 'deagle', fireSound: 'assets/sounds/cs_deagle_35_80.wav', isDarkGold: true, canvasImageProp: 'pistolImage',
    ...
    P4040_ITEM: {
        ...
        attackKey: 'p4040', offhandAttackKey: 'p4040Offhand', animConfigKey: 'p4040', fireSound: 'assets/sounds/apex2_shot_1s.wav', isDarkGold: true, canvasImageProp: 'pistolImage',
    ...
    PKM_ITEM: {
        ...
        equipSlot: 'weapon2',
        attack: { range: 1200, knockback: 3, attackInterval: 92, hitType: '亮金色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 4680 },
    ...
    AKM_ITEM: {
        ...
        equipSlot: 'weapon',
        attack: { range: 1200, knockback: 2, attackInterval: 100, hitType: '亮金色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 4680 },
    ...
    QBZ191_ITEM: {
        ...
        equipSlot: 'weapon',
        attack: { range: 1200, knockback: 2, attackInterval: 70, hitType: '亮金色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 5616 },
    ...
    QJB201_ITEM: {
        ...
        equipSlot: 'weapon',
        attack: { range: 1200, knockback: 1, attackInterval: 60, hitType: '亮金色曳光弹（直线弹道）', damageType: '物理', projectileSpeed: 2808 },
    ...
    SUPER90_ITEM: {
        ...
        equipSlot: 'weapon',
        attack: { range: 500, knockback: 12.5, attackInterval: 333, hitType: '散弹（6发弹丸）', damageType: '物理', projectileSpeed: 3900 },
    ...
    SAIGA12K_ITEM: {
        ...
        equipSlot: 'weapon',
        attack: { range: 400, knockback: 12.5, attackInterval: 150, hitType: '散弹（4发弹丸）', damageType: '物理', projectileSpeed: 2340 },
    ...
    ENERGY_LMG_ITEM: {
        ...
        equipSlot: 'weapon',
        attack: { range: 1200, knockback: 0, attackInterval: 333, hitType: '亮绿色曳光弹（直线弹道）', damageType: '魔法', projectileSpeed: 5616 },
    ...
    BORDER_BOW_ITEM: {
        ...
        equipSlot: 'weapon',
        attack: { range: 1500, knockback: 30, attackInterval: 1500, hitType: '箭矢（直线弹道）', damageType: '物理', projectileSpeed: 12168 },
        attackKey: 'ranged', animConfigKey: 'bow', fireMode: 'charge',
