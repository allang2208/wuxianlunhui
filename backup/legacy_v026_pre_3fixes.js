            ...
            renderSkillGrid() {
                ...
                body.innerHTML = `
                    <div class="sd-section">
                        ...
                        <div class="sd-stat-row"><span class="sd-stat-name">攻击间隔缩短</span><span class="sd-stat-val pos">${(effect.cooldownReduction * 100).toFixed(0)}%</span></div>
                        ${nextEffect ? `
                        ...
                        <div class="sd-stat-row"><span class="sd-stat-name">下一级冷却缩短</span><span class="sd-stat-val pos">${(nextEffect.cooldownReduction * 100).toFixed(0)}%</span></div>
