...
const ENEMY_DATA = {
    ...
    bigBoss: {
        name: "大块头", type: "区域首领", category: "monster",
        color: "#2a5a2a", size: 40,
        hp: 8000, maxHp: 8000,
        def: 91, speed: 35.1,
        attackRange: 90, attackCooldown: 1200,
        attackType: "近战突刺", knockback: 20,
        level: 20, rank: "area_boss",
        str: 90, dex: 45, con: 75, int: 3, wis: 5, luck: 3,
        atk: 51,
        description: "雪地场景的区域首领，体型庞大的僵尸变异体。拥有三种特殊技能：蓄力扇形斩（150px/120°，2倍伤害，6秒CD）、蓄力冲锋（800px/s冲向目标，3倍伤害，25秒CD，优先距离800px内目标）、召唤小僵尸（2只奔跑僵尸，60秒CD）。",
        skills: [
            { name: "蓄力扇形斩", desc: "蓄力1.5秒后释放150px/120°扇形斩击，造成2倍伤害，冷却6秒" },
            { name: "蓄力冲锋", desc: "蓄力1.5秒后向目标冲锋（800px/s），命中造成3倍伤害，冷却25秒，优先距离800px内目标" },
            { name: "召唤小僵尸", desc: "召唤2只奔跑僵尸，冷却60秒" }
        ]
    },
};
