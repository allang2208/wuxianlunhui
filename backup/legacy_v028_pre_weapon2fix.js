...
class SlashEffect {
        ...
        const EquipManager = {
            TEST_EQUIPMENTS: {
                ...
                weapon2: { weaponId: 'weapon2', name: '骑士长剑', type: '单手剑', icon: '⚔', iconImage: 'assets/icons/knights_sword_v3_macro.png', category: 'weapon_melee', equipSlot: 'weapon2', stats: [{ name: '物理攻击', value: '18-23' }, { name: '攻速', value: '1.1' }], desc: '骑士团的标准制式长剑，剑身修长，锋利且坚韧', level: 5, rarity: 'rare', weaponType: 'sword' },
...
/** 处理拖放放下逻辑 */
        ...
        const Game = {
            ...
            initAttackRangeToggle() {
                const btn = document.getElementById('attackRangeToggle');
                if (!btn) return;
                btn.onclick = () => {
                    this.showAttackRange = !this.showAttackRange;
                    btn.classList.toggle('active', this.showAttackRange);
                };
            },
            start() {
                try {
