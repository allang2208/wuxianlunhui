...
class SlashEffect {
        ...
        class DropItem extends Entity {
            constructor(x, y, itemData) {
                ...
                this.size = 16; this.active = true; this.life = Infinity; // 装备不自行消失
...
/** 处理拖放放下逻辑 */
        ...
        const Game = {
            ...
            update(dt) {
                ...
                // Z键范围拾取：检测并执行
                if (this._pickupNearbyFlag) {
                    this._pickupNearbyFlag = false;
            ...
            pickupNearbyItems() {
                ...
                if (pickedCount > 0) {
                    EffectManager.add(new FloatingTextEffect(px, py - 40, `范围拾取 ${pickedCount} 件物品`));
                }
            },
            // 实体碰撞体积解析：防止目标间堆叠
            resolveCollisions() {
