...
class SlashEffect {
        ...
        class ThrustAttack extends Attack {
            ...
            checkTriangleHit(source) {
                ...
                pt.entities.forEach(entity => {
                    ...
                    if (forward >= 0 && forward <= range && lateral >= -halfW && lateral <= halfW) {
        ...
        const Input = {
            ...
            handleKey(code) {
                ...
                if (SystemUI.isOpen) {
                    // 面板打开时：允许Tab切换快捷键，允许F切换武器，其他按键拦截
        ...
        class Player extends Entity {
            constructor(x, y) {
                ...
                this.attacks = {
                    melee: new ThrustAttack({ cooldown: 1100, range: 150, width: 35, damage: { min: 12, max: 20 }, knockback: 8 }),
