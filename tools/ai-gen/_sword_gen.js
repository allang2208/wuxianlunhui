// 剑类图标批量生成调度（4 并发，文件存在即视为成功）
// 用法: node tools/ai-gen/_sword_gen.js
const { spawn } = require('child_process');
const fs = require('fs');
const path = require('path');

const PROMPT_DIR = 'Y:\\工作\\无尽轮回\\scratch\\craft-icons\\prompts\\sword';
const RAW_DIR = 'Y:\\工作\\无尽轮回\\scratch\\craft-icons\\sword_raw';
const SEED_BASE = 910001;
const CONCURRENCY = 4;
