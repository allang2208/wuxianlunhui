#!/usr/bin/env python3
"""Apply the single permitted 2x RIFE pass to the approved idle sheet."""
...
def main() -> None:
    source = json.loads(
        (POST / "approved-idle-source-report.json").read_text(encoding="utf-8")
    )
    ...
    command = [
        ...
        "--out", str(output_dir / "idle.png"),
        "--name", "trench-assault-idle",
        ...
        "--report", str(report_dir / "idle.json"),
        "--repair-red-outliers",
    ]
