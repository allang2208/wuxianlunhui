#!/usr/bin/env python3
"""Copy the approved hamster-phalanx sheets and derive its runtime icon."""
...
REPO = ROOT.parents[2]
RUNTIME = REPO / "assets" / "companions" / "hamster_phalanx"
ICON = REPO / "assets" / "ui" / "unit-icons" / "hamster-phalanx.png"
CELL = 512
...
def main() -> None:
    ...
    print(f"[phalanx-finalize] runtime={RUNTIME}")
    print(f"[phalanx-finalize] icon={ICON}")
