...
ACTIONS = (
    ...
    "smoke-bomb",
    "smoke-bomb-v02",
    "attacking-v05-centered",
    "continuous-attacking-v04-centered",
)
VIDEO_NAMES = {
    "smoke-bomb-v02": "smoke-bomb-doubao-v02.mp4",
    "attacking-v05-centered": "attacking-doubao-v05-centered.mp4",
    "continuous-attacking-v04-centered": "continuous-attacking-doubao-v04-centered.mp4",
}


def build_preview(action: str) -> None:
    source = VIDEO_DIR / VIDEO_NAMES.get(action, f"{action}-doubao.mp4")
    output = PREVIEW_DIR / f"{action}-preview.gif"
