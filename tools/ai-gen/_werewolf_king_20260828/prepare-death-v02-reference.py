#!/usr/bin/env python3
"""Build a deliberately small, fixed-scale death reference for Seedance."""
...
OUTPUT = ROOT / "references" / "werewolf-king-armored-death-v02-safe-white-1024x576.png"
...
def main() -> None:
    ...
    # The rejected v01 used 360 px. Seedance reframed it as a close-up during
    # the fall, so v02 starts at only 45.1% of the 576 px canvas height.
    target_height = 260
