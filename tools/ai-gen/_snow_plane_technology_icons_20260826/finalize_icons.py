#!/usr/bin/env python3
"""Finalize the two snow-plane technology badges for runtime use."""
...
NAMES = ("snow_castle_architecture", "snow_ninjutsu")
...
def make_preview(icons: dict[str, Image.Image]) -> None:
    ...
    canvas.convert("RGB").save(ROOT / "snow-plane-technology-icons-preview.jpg", quality=94)
