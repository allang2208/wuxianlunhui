#!/usr/bin/env python3
"""Fit approved signature-action keyframes onto safe 1024x576 H3 canvases."""
...
SPECS = [
    {
        ...
        "output": "01-snow-sepulcher-carrier-plow-prepare-1024x576.png",
        "max_size": (520, 420),
        "center_x": 355,
        "foot_y": 522,
        "label": "01 carrier / plow_prepare / recover",
    },
    {
        "source": "02-aurora-fate-weaver-triangle-prepare-v01.png",
        "output": "02-aurora-fate-weaver-triangle-prepare-1024x576.png",
        "max_size": (560, 400),
        "center_x": 365,
        "foot_y": 516,
        "label": "02 weaver / triangle_weave / recover",
    },
    {
        "source": "03-white-silence-bell-hart-double-toll-prepare-v03.png",
        "output": "03-white-silence-bell-hart-double-toll-prepare-1024x576.png",
        "max_size": (460, 430),
        "center_x": 415,
        "foot_y": 522,
        "label": "03 bell hart / double_toll / recover",
    },
]
...
def fit(spec: dict[str, object]) -> Image.Image:
    ...
    print(f"[h3-action-reference] {spec['output']}: source={source.size} fitted={fitted.size} at {(x, y)}")
    return canvas
...
def main() -> None:
    ...
    contact.save(OUT / "signature-action-reference-contact.png")
