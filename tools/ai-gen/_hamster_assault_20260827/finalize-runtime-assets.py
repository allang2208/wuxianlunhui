#!/usr/bin/env python3
"""Publish approved hamster-assault RIFE sheets and derive its UI icon."""
...
RUNTIME = REPO / "assets" / "companions" / "hamster_assault"
ICON = REPO / "assets" / "ui" / "unit-icons" / "hamster-assault.png"
