#!/usr/bin/env python3
"""Apply mandatory 2x RIFE to accepted hamster-special-forces source sheets."""
...
ACTIONS = {
    ...
    "running": {"count": 14, "rate": 12, "mode": "loop"},
...
def main() -> None:
    ...
    print(f"[special-forces-rife] wrote {ROOT / 'interpolation-report.json'}")
