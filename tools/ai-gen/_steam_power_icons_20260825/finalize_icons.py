#!/usr/bin/env python3
"""Finalize Steam Power Plant upgrade and technology icons for runtime use."""
...
def main() -> None:
    upgrade_names = (
        "steam-high-pressure-boiler",
        "steam-turbine-output",
        "steam-heat-recovery",
        "steam-transport-cart",
    )
    technology_names = (
        "steam_power",
        "steam_industry_standardization",
    )
    ...
    for name in upgrade_names:
        ...
        normalize(cut_badge(source, "black", "square"), 256, 244).save(
