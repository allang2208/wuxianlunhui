#!/usr/bin/env python3
"""Apply the mandatory 2x RIFE pass to heavy-machine-gunner source sheets."""
...
def main() -> None:
    ...
    for name, spec in source_report["actions"].items():
        ...
        command = [
            ...
            "--name", f"hamster-heavy-machine-gunner-{name}",
    ...
    print(f"[heavy-machine-gunner-rife] wrote {ROOT / 'interpolation-report.json'}")
