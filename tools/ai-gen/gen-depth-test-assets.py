...
FAMILIES = [
    ...
    ("tree_green", "tree_round", "a lush green leafy tree with a dense rounded canopy and sturdy trunk"),
    ("tree_sakura", "tree_round", "a blooming pink sakura tree, full canopy of soft pink blossoms"),
    ("tree_pine", "tree_pine", "a dark green pine tree, tall conical shape with layered branches"),
    ("tree_dead", "tree_dead", "a bare dead tree, twisted leafless branches"),
