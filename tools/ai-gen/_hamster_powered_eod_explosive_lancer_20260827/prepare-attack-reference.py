#!/usr/bin/env python3
"""Build a smaller left-weighted H3 reference for charge and lance attacks."""
...
OUTPUT = ROOT / "references" / "hamster-powered-eod-explosive-lancer-attack-safe-white-1024x576.png"
